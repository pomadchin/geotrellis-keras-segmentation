...
object NewHadoopGeoTiffRDD {
  ...
  /**
    ...
    */
  private def configuration(path: Path, options: NewHadoopGeoTiffRDD.Options)(implicit sc: SparkContext): Configuration = {
  ...
  /**
    ...
    * @param options  An instance of [[Options]] that contains any user defined or default settings.
    */
  def apply[K, V](path: Path, options: Options = Options.DEFAULT)(implicit sc: SparkContext, rr: RasterReader[Options, (K, V)]): RDD[(Path, (K, V))] = {
    ...
    options.maxTileSize match {
      ...
      case None =>
        sc.newAPIHadoopRDD(
          ...
          _.map { case (p, bytes) => p -> rr.readFully(ByteBuffer.wrap(bytes), options) },
  ...
  /**
    ...
    */
  def spatial(path: Path)(implicit sc: SparkContext): RDD[(Path, (ProjectedExtent, Tile))] =
  ...
  /**
    ...
    * @param options  An instance of [[Options]] that contains any user defined or default settings.
    */
  def spatial(path: Path, options: Options)(implicit sc: SparkContext): RDD[(Path, (ProjectedExtent, Tile))] =
  ...
  /**
    ...
    * @param path     Hadoop path to recursively search for GeoTiffs.
    */
  def spatialMultiband(path: Path)(implicit sc: SparkContext): RDD[(Path, (ProjectedExtent, MultibandTile))] =
  ...
  /**
    ...
    * @param options  An instance of [[Options]] that contains any user defined or default settings.
    */
  def spatialMultiband(path: Path, options: Options)(implicit sc: SparkContext): RDD[(Path, (ProjectedExtent, MultibandTile))] =
  ...
  /**
    ...
    * @param path     Hadoop path to recursively search for GeoTiffs.
    */
  def temporal(path: Path)(implicit sc: SparkContext): RDD[(Path, (TemporalProjectedExtent, Tile))] =
  ...
  /**
    ...
    * @param options  An instance of [[Options]] that contains any user defined or default settings.
    */
  def temporal(path: Path, options: Options)(implicit sc: SparkContext): RDD[(Path, (TemporalProjectedExtent, Tile))] =
  ...
  /**
    ...
    * @param path     Hadoop path to recursively search for GeoTiffs.
    */
  def temporalMultiband(path: Path)(implicit sc: SparkContext): RDD[(Path, (TemporalProjectedExtent, MultibandTile))] =
  ...
  /**
    ...
    * @param options  An instance of [[Options]] that contains any user defined or default settings.
    */
  def temporalMultiband(path: Path, options: Options)(implicit sc: SparkContext): RDD[(Path, (TemporalProjectedExtent, MultibandTile))] =
